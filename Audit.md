...
- This report was generated by Cake.AddinDiscoverer v1.2.0 on Monday, April 9, 2018 at 12:02:04 PM GMT
...
- Of the 193 audited addins:
  - 10.9 % are targeting the desired .NET framework
  - 50.3 % are using the cake-contrib icon
  - 76.7 % have a YAML file on the cake web site

- Of the 192 audited addins that reference Cake.Core:
  - 39.6 % are targeting the desired version of Cake.Core
  - 24.0 % have marked the reference to Cake.Core as private
...
**Cake.XComponent**: FindSolutionPathAsync: Server Error
This addin seem to be referencing neither Cake.Core nor Cake.Common.
