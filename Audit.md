...
- The analysis discovered 373 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5223 packages on NuGet.org

## Statistics

- Of the 373 audited nuget packages:
  - 312 are addins
  - 11 are modules
  - 21 are recipes
  - 20 are marked as deprecated
  - 9 could not be audited (see the 'Exceptions' section)
- Of the 344 successfully analyzed packages:
  ...
  - 224 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
