...
- The analysis discovered 355 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4347 packages on NuGet.org

## Statistics

- Of the 355 audited nuget packages:
  - 300 are addins
  - 11 are modules
  - 18 are recipes
  - 18 are marked as deprecated
  - 8 could not be audied (see the 'Exceptions' section)
- Of the 329 successfully analyzed packages:
