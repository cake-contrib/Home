...
- The analysis discovered 305 NuGet packages
  - 277 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 303 categorized packages:
  - 290 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 290 audited addins:
  ...
  - 74 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
