...
- Of the 278 audited addins:
  - 102 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 37 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
