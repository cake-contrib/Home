...
This report was generated by Cake.AddinDiscoverer 5.26.1 on Wednesday, September 23, 2026 at 12:06:37 PM GMT

## Overall statistics

- The analysis discovered 382 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5586 packages on NuGet.org

## Statistics

- Of the 382 audited nuget packages:
  - 319 are addins
  - 11 are modules
  - 21 are recipes
  - 20 are marked as deprecated
  - 11 could not be audited (see the 'Exceptions' section)
- Of the 351 successfully analyzed packages:
  ...
  - 232 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
