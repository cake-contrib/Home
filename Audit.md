...
- If you count all the versions of these addins, there's a grand total of 4708 packages on NuGet.org
...
- Of the 336 successfully analyzed packages:
  ...
  - 99 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 81 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
