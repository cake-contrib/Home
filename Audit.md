...
- The analysis discovered 310 NuGet packages
  - 282 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 308 categorized packages:
  - 295 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 295 audited addins:
  ...
  - 72 are using a custom icon hosted on a web site
  - 0 are embedding the cake-contrib icon
  - 0 are embedding a custom icon
  - 143 have been transferred to the cake-contrib organisation
  - 147 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
