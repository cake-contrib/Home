...
This report was generated by Cake.AddinDiscoverer 5.8.0 on Wednesday, November 15, 2023 at 12:05:04 PM GMT

## Overall statistics

- The analysis discovered 360 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4396 packages on NuGet.org
...
- Of the 360 audited nuget packages:
  ...
  - 7 could not be audied (see the 'Exceptions' section)
- Of the 334 successfully analyzed packages:
  ...
  - 65 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 9 are embedding a custom icon
  - 183 have been transferred to the cake-contrib organization
  - 214 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
