...
This report was generated by Cake.AddinDiscoverer 5.18.0 on Wednesday, September 3, 2025 at 12:06:25 PM GMT

## Overall statistics

- The analysis discovered 375 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5279 packages on NuGet.org
...
**Cake.Bridge.DependencyInjection.Testing.Tests**: AnalyzeNugetMetadata: Could not find assembly 'xunit.v3.runner.common, Version=3.0.0.0, Culture=neutral, PublicKeyToken=8d05b1bb7a6fdb6c'. Either explicitly load this assembly using a method such as LoadFromAssemblyPath() or use a MetadataAssemblyResolver that returns a valid assembly.
