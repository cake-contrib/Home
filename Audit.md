...
- This report was generated by Cake.AddinDiscoverer v1.2.0 on Saturday, April 14, 2018 at 12:01:54 PM GMT
...
- The analysis discovered 217 addins
  - 195 were successfully audited (see the 'Addins' section)
  - 22 could not be audited (see the 'Exceptions' section)

- Of the 195 audited addins:
  - 10.8 % are targeting the desired .NET framework
  - 50.3 % are using the cake-contrib icon
  - 76.4 % have a YAML file on the cake web site

- Of the 194 audited addins that reference Cake.Core:
  - 41.2 % are targeting the desired version of Cake.Core
  - 23.2 % have marked the reference to Cake.Core as private
