...
- If you count all the versions of these addins, there's a grand total of 5468 packages on NuGet.org
...
- Of the 381 audited nuget packages:
  ...
  - 28 could not be audited (see the 'Exceptions' section)
- Of the 333 successfully analyzed packages:
  ...
  - 93 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 223 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
