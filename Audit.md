...
- Of the 279 audited addins:
  - 84 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 57 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
