...
- Of the 294 audited addins:
  - 44 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 130 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 140 have been transferred to the cake-contrib organisation
  - 133 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
