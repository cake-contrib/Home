...
- The analysis discovered 302 NuGet packages
  - 274 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 300 categorized packages:
  - 285 were successfully audited
  - 12 were marked as deprecated
  - 3 could not be audited (see the 'Exceptions' section)

- Of the 285 audited addins:
  - 74 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  ...
  - 62 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
