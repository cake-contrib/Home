...
- The analysis discovered 347 NuGet packages
  - 312 addins
  - 21 recipes
  - 11 modules
...
- Of the 329 audited addins:
  ...
  - 136 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  - 45 are using a custom icon hosted on a web site
  - 54 are embedding the cake-contrib icon (which is the current recommendation)
