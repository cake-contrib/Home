...
- Of the 329 audited addins:
  ...
  - 135 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  - 44 are using a custom icon hosted on a web site
  - 55 are embedding the cake-contrib icon (which is the current recommendation)
