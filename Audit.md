...
- If you count all the versions of these addins, there's a grand total of 5474 packages on NuGet.org
...
- Of the 330 successfully analyzed packages:
  ...
  - 91 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
