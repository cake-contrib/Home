...
- Of the 325 audited addins:
  ...
  - 181 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
