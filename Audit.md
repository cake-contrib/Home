...
- Of the 317 audited addins:
  ...
  - 17 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 6 are embedding a custom icon
  - 175 have been transferred to the cake-contrib organization
  - 193 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
