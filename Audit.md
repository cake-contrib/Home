...
- The analysis discovered 329 NuGet packages
  - 300 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 327 categorized packages:
  - 312 were successfully audited
  - 14 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 312 audited addins:
  ...
  - 2 are embedding a custom icon
  - 148 have been transferred to the cake-contrib organisation
  - 163 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
