...
- Of the 321 audited addins:
  ...
  - 165 have been transferred to the cake-contrib organization
  - 176 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
