...
- Of the 327 audited addins:
  ...
  - 103 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 177 have been transferred to the cake-contrib organization
  - 202 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
...
**Cake.SonarResults**: GetGithubMetadata: 500: Internal Server Error
