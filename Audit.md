...
- If you count all the versions of these addins, there's a grand total of 4656 packages on NuGet.org
...
- Of the 336 successfully analyzed packages:
  ...
  - 100 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 80 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
