...
- The analysis discovered 316 NuGet packages
  - 287 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 314 categorized packages:
  - 301 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 301 audited addins:
  ...
  - 154 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
