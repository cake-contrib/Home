...
This report was generated by Cake.AddinDiscoverer 5.7.0 on Wednesday, September 27, 2023 at 12:04:20 PM GMT

## Overall statistics

- The analysis discovered 357 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4378 packages on NuGet.org
...
- Of the 331 successfully analyzed packages:
  ...
  - 64 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 9 are embedding a custom icon
  - 182 have been transferred to the cake-contrib organization
  - 211 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
