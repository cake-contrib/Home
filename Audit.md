...
- Of the 330 audited addins:
  ...
  - 59 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 9 are embedding a custom icon
  - 179 have been transferred to the cake-contrib organization
  - 207 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
