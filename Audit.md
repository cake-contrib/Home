...
- The analysis discovered 315 NuGet packages
  - 286 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 313 categorized packages:
  - 300 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 300 audited addins:
  ...
  - 73 are using a custom icon hosted on a web site
  ...
  - 153 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
