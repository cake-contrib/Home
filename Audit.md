...
- If you count all the versions of these addins, there's a grand total of 5153 packages on NuGet.org
...
- Of the 340 successfully analyzed packages:
  ...
  - 86 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
