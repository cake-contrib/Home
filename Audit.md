...
- The analysis discovered 340 NuGet packages
  - 309 addins
  - 16 recipes
  - 12 modules
  - 3 uncategorized (see the 'Exceptions' section)
- Of the 337 categorized packages:
  - 323 were successfully audited
  - 14 were marked as deprecated
  - 0 could not be audited (see the 'Exceptions' section)

- Of the 323 audited addins:
  ...
  - 179 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
