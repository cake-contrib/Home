...
- The analysis discovered 330 NuGet packages
  - 301 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 328 categorized packages:
  - 313 were successfully audited
  - 14 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 313 audited addins:
  ...
  - 165 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
