...
- Of the 320 audited addins:
  ...
  - 35 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 7 are embedding a custom icon
  - 175 have been transferred to the cake-contrib organization
  - 196 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
