...
- Of the 315 audited addins:
  ...
  - 122 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  - 43 are using a custom icon hosted on a web site
  - 68 are embedding the cake-contrib icon (which is the current recommendation)
