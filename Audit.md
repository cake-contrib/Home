...
- The analysis discovered 378 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5414 packages on NuGet.org

## Statistics

- Of the 378 audited nuget packages:
  - 301 are addins
  - 11 are modules
  - 20 are recipes
...
- Of the 332 successfully analyzed packages:
  ...
  - 91 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 12 are embedding a custom icon
  - 184 have been transferred to the cake-contrib organization
...
**Cake.SimpleGitVer**: GetGithubMetadata: The requested operation requires an element of type 'Object', but the target element has type 'Null'.
