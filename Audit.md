...
- Of the 291 audited addins:
  ...
  - 86 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 126 have been transferred to the cake-contrib organisation
