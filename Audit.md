...
- Of the 291 audited addins:
  - 67 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 79 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 123 have been transferred to the cake-contrib organisation
  - 75 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
