...
- The analysis discovered 333 NuGet packages
  - 304 addins
  - 16 recipes
  - 11 modules
...
- Of the 316 audited addins:
  ...
  - 167 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
