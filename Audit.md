...
- The analysis discovered 327 NuGet packages
  - 298 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 325 categorized packages:
  - 310 were successfully audited
  - 14 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 310 audited addins:
  ...
  - 18 are embedding the cake-contrib icon (which is the current recommendation)
  - 2 are embedding a custom icon
  - 148 have been transferred to the cake-contrib organisation
  - 162 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
