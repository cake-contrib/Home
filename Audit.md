...
- The analysis discovered 326 NuGet packages
  - 297 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 324 categorized packages:
...
- Of the 309 audited addins:
  ...
  - 147 have been transferred to the cake-contrib organisation
  - 160 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
