...
- If you count all the versions of these addins, there's a grand total of 5501 packages on NuGet.org
...
- Of the 381 audited nuget packages:
  ...
  - 34 could not be audited (see the 'Exceptions' section)
- Of the 327 successfully analyzed packages:
  - 27 are using the cake-contrib icon on the rawgit CDN (which has been shutdown since October 2019)
  - 90 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 217 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
