...
- Of the 315 audited addins:
  - 33 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 117 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
