...
- The analysis discovered 356 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4359 packages on NuGet.org

## Statistics

- Of the 356 audited nuget packages:
  - 301 are addins
  - 11 are modules
  - 18 are recipes
