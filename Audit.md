...
- Of the 316 audited addins:
  ...
  - 43 are embedding the cake-contrib icon (which is the current recommendation)
  - 30 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
