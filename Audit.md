...
- This report was generated by Cake.AddinDiscoverer v1.2.0 on Tuesday, April 17, 2018 at 12:02:47 PM GMT
...
- The analysis discovered 217 addins
  - 196 were successfully audited (see the 'Addins' section)
  - 21 could not be audited (see the 'Exceptions' section)

- Of the 196 audited addins:
  - 10.7 % are targeting the desired .NET framework
  - 50.0 % are using the cake-contrib icon
  - 76.5 % have a YAML file on the cake web site

- Of the 195 audited addins that reference Cake.Core:
  - 45.6 % are targeting the desired version of Cake.Core
  - 23.6 % have marked the reference to Cake.Core as private

- Of the 48 audited addins that reference Cake.Common:
  - 54.2 % are targeting the desired version of Cake.Common
  - 27.1 % have marked the reference to Cake.Common as private
