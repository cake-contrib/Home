...
- If you count all the versions of these addins, there's a grand total of 4563 packages on NuGet.org
...
- Of the 336 successfully analyzed packages:
  ...
  - 78 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
