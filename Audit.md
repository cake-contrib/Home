...
- Of the 326 audited addins:
  ...
  - 130 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  - 44 are using a custom icon hosted on a web site
  - 59 are embedding the cake-contrib icon (which is the current recommendation)
