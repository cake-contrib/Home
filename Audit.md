...
- Of the 280 audited addins:
  - 76 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 65 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
