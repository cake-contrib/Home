...
- This report was generated by Cake.AddinDiscoverer v1.2.0 on Wednesday, April 18, 2018 at 12:02:50 AM GMT
...
- The analysis discovered 218 addins
  - 197 were successfully audited (see the 'Addins' section)
  - 21 could not be audited (see the 'Exceptions' section)

- Of the 197 audited addins:
  - 11.2 % are targeting the desired .NET framework
  - 50.8 % are using the cake-contrib icon
  - 76.1 % have a YAML file on the cake web site

- Of the 196 audited addins that reference Cake.Core:
  - 46.4 % are targeting the desired version of Cake.Core
  - 23.0 % have marked the reference to Cake.Core as private
...
| [Cake.AppCenter](https://github.com/cake-contrib/Cake.AppCenter) | 0.26.0 :white_check_mark: | false :small_red_triangle: |  |  | netstandard2.0 :white_check_mark: | true :white_check_mark: | false :small_red_triangle: |
