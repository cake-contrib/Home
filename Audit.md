...
- The analysis discovered 313 NuGet packages
  - 284 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 311 categorized packages:
  - 298 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 298 audited addins:
  ...
  - 144 have been transferred to the cake-contrib organisation
  - 150 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
