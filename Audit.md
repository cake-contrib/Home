...
- The analysis discovered 304 NuGet packages
  - 276 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 302 categorized packages:
...
- Of the 289 audited addins:
  ...
  - 78 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 123 have been transferred to the cake-contrib organisation
  - 72 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
