...
- The analysis discovered 296 NuGet packages
  - 268 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 294 categorized packages:
  - 281 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 281 audited addins:
  ...
  - 59 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
