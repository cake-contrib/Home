...
- The analysis discovered 383 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5587 packages on NuGet.org

## Statistics

- Of the 383 audited nuget packages:
  - 320 are addins
  - 11 are modules
  - 21 are recipes
  - 20 are marked as deprecated
  - 11 could not be audited (see the 'Exceptions' section)
- Of the 352 successfully analyzed packages:
  ...
  - 22 are embedding the cake-contrib icon (which is the current recommendation)
  ...
  - 233 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
