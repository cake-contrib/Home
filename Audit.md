...
This report was generated by Cake.AddinDiscoverer 5.24.1 on Wednesday, May 27, 2026 at 12:05:40 AM GMT
...
- Of the 381 audited nuget packages:
  ...
  - 31 could not be audited (see the 'Exceptions' section)
- Of the 330 successfully analyzed packages:
  ...
  - 94 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 12 are embedding a custom icon
  - 183 have been transferred to the cake-contrib organization
  - 220 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
