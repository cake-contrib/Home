...
- The analysis discovered 317 NuGet packages
  - 288 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 315 categorized packages:
  - 302 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 302 audited addins:
  ...
  - 155 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
