...
- If you count all the versions of these addins, there's a grand total of 4474 packages on NuGet.org
...
- Of the 335 successfully analyzed packages:
  ...
  - 69 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
