...
- The analysis discovered 375 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5285 packages on NuGet.org

## Statistics

- Of the 375 audited nuget packages:
  - 314 are addins
  - 11 are modules
  - 21 are recipes
