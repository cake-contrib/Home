...
- Of the 341 categorized packages:
  - 326 were successfully audited
  - 15 were marked as deprecated
  - 0 could not be audited (see the 'Exceptions' section)

- Of the 326 audited addins:
  ...
  - 38 are embedding the cake-contrib icon (which is the current recommendation)
  - 6 are embedding a custom icon
  - 168 have been transferred to the cake-contrib organization
  - 182 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
