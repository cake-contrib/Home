...
- Of the 280 audited addins:
  - 79 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 62 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 115 have been transfered to the cake-contrib organisation
  - 53 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
