...
- The analysis discovered 323 NuGet packages
  - 294 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 321 categorized packages:
  - 308 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 308 audited addins:
  ...
  - 158 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
