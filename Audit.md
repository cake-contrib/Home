...
- The analysis discovered 359 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4386 packages on NuGet.org

## Statistics

- Of the 359 audited nuget packages:
  - 303 are addins
  - 11 are modules
  - 18 are recipes
