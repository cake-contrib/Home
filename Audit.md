...
- Of the 295 audited addins:
  ...
  - 138 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 70 are using a custom icon hosted on a web site
  - 2 are embedding the cake-contrib icon
