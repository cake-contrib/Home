...
- The analysis discovered 307 NuGet packages
  - 279 addins
  - 16 recipes
  - 10 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 305 categorized packages:
  - 289 were successfully audited
  - 12 were marked as deprecated
  - 4 could not be audited (see the 'Exceptions' section)

- Of the 289 audited addins:
  - 61 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 85 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 125 have been transferred to the cake-contrib organisation
  - 81 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
...
**Cake.AndroidAppManifest**: GetGithubInfo: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond

**Cake.Apigee**: GetGithubInfo: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond

**Cake.ApiReference.Uploader**: GetGithubInfo: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond
