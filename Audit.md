...
- The analysis discovered 366 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5136 packages on NuGet.org

## Statistics

- Of the 366 audited nuget packages:
  - 310 are addins
  - 11 are modules
  - 18 are recipes
  - 20 are marked as deprecated
  - 7 could not be audited (see the 'Exceptions' section)
- Of the 339 successfully analyzed packages:
  ...
  - 85 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 9 are embedding a custom icon
  - 186 have been transferred to the cake-contrib organization
  - 219 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
