...
- Of the 278 audited addins:
  - 114 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 24 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 113 have been transfered to the cake-contrib organisation
  - 30 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
