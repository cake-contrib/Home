...
- The analysis discovered 318 NuGet packages
  - 289 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 316 categorized packages:
  - 303 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 303 audited addins:
  ...
  - 156 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
