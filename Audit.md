...
- The analysis discovered 314 NuGet packages
  - 285 addins
  - 16 recipes
  - 11 modules
  - 2 uncategorized (see the 'Exceptions' section)
- Of the 312 categorized packages:
  - 299 were successfully audited
  - 12 were marked as deprecated
  - 1 could not be audited (see the 'Exceptions' section)

- Of the 299 audited addins:
  ...
  - 151 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
