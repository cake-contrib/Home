...
- Of the 315 audited addins:
  ...
  - 116 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 12 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 6 are embedding a custom icon
  - 173 have been transferred to the cake-contrib organization
