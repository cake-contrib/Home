...
- If you count all the versions of these addins, there's a grand total of 4477 packages on NuGet.org
...
- Of the 335 successfully analyzed packages:
  ...
  - 25 are embedding the cake-contrib icon (which is the current recommendation)
  - 72 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
