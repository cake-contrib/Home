...
- The analysis discovered 365 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5046 packages on NuGet.org

## Statistics

- Of the 365 audited nuget packages:
  - 309 are addins
  - 11 are modules
  - 18 are recipes
  - 20 are marked as deprecated
  - 7 could not be audited (see the 'Exceptions' section)
- Of the 338 successfully analyzed packages:
