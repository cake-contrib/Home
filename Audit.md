...
- Of the 291 audited addins:
  - 64 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 84 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 125 have been transferred to the cake-contrib organisation
  - 80 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
