...
- If you count all the versions of these addins, there's a grand total of 4387 packages on NuGet.org
...
- Of the 333 successfully analyzed packages:
  ...
  - 213 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
