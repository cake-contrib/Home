...
- The analysis discovered 363 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5005 packages on NuGet.org

## Statistics

- Of the 363 audited nuget packages:
  - 307 are addins
  - 11 are modules
  - 18 are recipes
