...
- The analysis discovered 374 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 5226 packages on NuGet.org

## Statistics

- Of the 374 audited nuget packages:
  - 313 are addins
  - 11 are modules
  - 21 are recipes
  - 20 are marked as deprecated
  - 9 could not be audited (see the 'Exceptions' section)
- Of the 345 successfully analyzed packages:
  ...
  - 225 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
