...
- Of the 286 audited addins:
  - 72 are using the cake-contrib icon on the rawgit CDN (which will be shutdown in October 2019)
  - 70 are using the cake-contrib icon on the jsDelivr CDN (which is our preferred CDN to replace rawgit)
  - 116 have been transferred to the cake-contrib organisation
  - 64 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
