...
- If you count all the versions of these addins, there's a grand total of 5538 packages on NuGet.org
...
- Of the 350 successfully analyzed packages:
  ...
  - 98 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
