...
- The analysis discovered 361 distinct nuget packages.
- If you count all the versions of these addins, there's a grand total of 4472 packages on NuGet.org

## Statistics

- Of the 361 audited nuget packages:
  - 306 are addins
  - 11 are modules
  - 18 are recipes
...
- Of the 335 successfully analyzed packages:
  ...
  - 67 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
  - 9 are embedding a custom icon
  - 184 have been transferred to the cake-contrib organization
  - 215 have replaced the obsolete `licenseUrl` with proper license metadata (see the `Additional audit results` section below for details)
