...
- Of the 322 audited addins:
  ...
  - 108 are using the cake-contrib icon on the jsDelivr CDN (which was our preferred CDN to replace rawgit)
  ...
  - 42 are embedding one of the "fancy" cake-contrib icons (which is also recommended)
