...
- This report was generated by Cake.AddinDiscoverer v1.2.0 on Sunday, April 15, 2018 at 12:03:03 PM GMT
...
- The analysis discovered 217 addins
  - 187 were successfully audited (see the 'Addins' section)
  - 30 could not be audited (see the 'Exceptions' section)

- Of the 187 audited addins:
  - 9.6 % are targeting the desired .NET framework
  - 50.8 % are using the cake-contrib icon
  - 80.2 % have a YAML file on the cake web site

- Of the 186 audited addins that reference Cake.Core:
  - 44.6 % are targeting the desired version of Cake.Core
  - 23.1 % have marked the reference to Cake.Core as private

- Of the 45 audited addins that reference Cake.Common:
  - 51.1 % are targeting the desired version of Cake.Common
  - 26.7 % have marked the reference to Cake.Common as private
...
**Cake.CakeBoss**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.

**Cake.ClickTwice**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.
...
**Cake.GithubUtility**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.

**Cake.Gradle**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.

**Cake.Grunt**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.

**Cake.Handlebars**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.

**Cake.Helm**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.
...
**Cake.MonoApiTools**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.
...
**Cake.ScheduledTasks**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.
...
**Cake.TravisCI**: We were unable to determine the Github repo URL. Most likely this means that the PackageProjectUrl is missing from the csproj.
