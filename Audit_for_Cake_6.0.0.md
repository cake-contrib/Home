...
- The `Cake Core IsPrivate` and `Cake Common IsPrivate` columns indicate whether the references are marked as private. In other words, we are looking for references with the `PrivateAssets=All` attribute like in this example: `<PackageReference Include="Cake.Common" Version="6.0.0" PrivateAssets="All" />`
- The `Framework` column shows the .NET framework(s) targeted by a given addin. Addins should target net8.0 and net9.0 and net10.0 at a minimum

## Statistics

- Of the 320 audited addins that reference Cake.Core:
  - 46 are targeting the desired version of Cake.Core
  - 277 have marked the reference to Cake.Core as private

- Of the 48 audited addins that reference Cake.Common:
  - 6 are targeting the desired version of Cake.Common
  - 38 have marked the reference to Cake.Common as private

## Package

| Name | Cake Core Version | Cake Core IsPrivate | Cake Common Version | Cake Common IsPrivate | Framework |
| --- | :---: | :---: | :---: | :---: | :---: |
| [Cake.7zip 5.0.0](https://cake-contrib.github.io/Cake.7zip/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.AppVeyor 10.0.0](https://github.com/cake-contrib/Cake.AppVeyor/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.AsciiDoctorJ 6.0.0](https://cake-contrib.github.io/cake.asciidoctorj/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.AzureCli 1.3.2](https://github.com/lprichar/Cake.AzureCli/) | 3.0.0 :x: |  :white_check_mark: | 3.0.0 :x: |  :white_check_mark: | net6.0, net7.0 :x: |
| [Cake.AzureDevOps 5.0.3](https://cake-contrib.github.io/Cake.AzureDevOps/) | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :white_check_mark: | net8.0, net9.0 :x: |
...
| [Cake.Codecov 6.0.0](https://github.com/cake-contrib/Cake.Codecov/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Compression 0.4.0](https://github.com/akordowski/Cake.Compression/) | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :x: | net8.0, net9.0 :x: |
...
| [Cake.Coveralls 6.0.0](https://github.com/cake-contrib/Cake.Coveralls/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Coverlet 6.0.1](https://github.com/Romanx/Cake.Coverlet/) | 6.1.0 :warning: |  :white_check_mark: | 6.1.0 :warning: |  :white_check_mark: | net8.0, net10.0 :x: |
...
| [Cake.CycloneDX 0.0.5](https://github.com/mgnslndh/Cake.CycloneDX/) | 6.1.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Discord 6.0.0](https://github.com/cake-contrib/Cake.Discord/) | 6.0.0 :white_check_mark: |  :white_check_mark: | 6.0.0 :white_check_mark: |  :white_check_mark: | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Docker 1.5.0](https://github.com/MihaMarkic/Cake.Docker/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.DotNetOutdated 0.1.0-preview.2](https://github.com/mgnslndh/Cake.DotNetOutdated/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Eazfuscator.Net 6.0.0](https://github.com/cake-contrib/Cake.Eazfuscator.Net/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Email 5.1.0](https://github.com/cake-contrib/Cake.Email/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.ESLint 4.0.0](https://github.com/cake-contrib/Cake.ESLint/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.ExtractLicenses 3.1.0](https://github.com/wgnf/liz/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net10.0 :x: |
...
| [Cake.FileHelpers 9.0.0](https://github.com/cake-contrib/Cake.FileHelpers/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.FileSet 2.0.0](https://github.com/Korthax/Cake.FileSet/) | 0.33.0 :x: |  :white_check_mark: |  |  | netstandard2.0 :x: |
| [Cake.Flatpak 1.1.2](https://codeberg.org/mihamarkic/Cake.Flatpak) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Git 5.0.1](https://github.com/cake-contrib/Cake_Git/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
| Cake.Git.Clog 1.0.0.2 | 1.1.0 :x: |  :x: | 1.1.0 :x: |  :x: | netstandard2.0 :x: |
| Cake.GitHooks 1.1.1 | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :x: | net9.0 :x: |
...
| [Cake.GitLab 1.0.108](https://github.com/ap0llo/Cake.GitLab/) | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :white_check_mark: | net8.0, net9.0 :x: |
...
| [Cake.GitVersioning 3.10.94](https://github.com/dotnet/Nerdbank.GitVersioning/) | 5.1.0 :x: |  :white_check_mark: |  |  | net8.0 :x: |
| [Cake.GoogleTest 1.0.0](https://github.com/TheFieryScythe/Cake.GoogleTest/) | 5.0.0 :x: |  :x: |  |  | net8.0 :x: |
| [Cake.Gradle 5.0.0](https://github.com/cake-contrib/Cake.Gradle/) | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :white_check_mark: | net8.0, net9.0 :x: |
...
| [Cake.Grype 0.1.0-preview.1](https://github.com/mgnslndh/Cake.Grype/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Gulp 6.0.1](https://github.com/cake-contrib/Cake.Gulp/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Http 5.1.0](https://github.com/cake-contrib/Cake.Http/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.Incubator 11.0.0](https://github.com/cake-contrib/Cake.Incubator/) | 6.0.0 :white_check_mark: |  :white_check_mark: | 6.0.0 :white_check_mark: |  :white_check_mark: | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.ISO 3.0.0](https://github.com/cake-contrib/Cake.ISO/) | 3.0.0 :x: |  :white_check_mark: |  |  | net6.0, net7.0 :x: |
| [Cake.Issues 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.BuildServer 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.BuildServer.AppVeyor 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: | 6.2.0 :warning: |  :white_check_mark: | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.BuildServer.GitHubActions 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.DocFx 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.DupFinder 2.0.0](https://cakeissues.net/) | 2.0.0 :x: |  :white_check_mark: |  |  | netcoreapp3.1, net5.0, net6.0 :x: |
| [Cake.Issues.EsLint 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.GitRepository 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.InspectCode 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Markdownlint 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.MsBuild 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.PullRequests 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.PullRequests.AppVeyor 5.9.1](https://cakeissues.net/) | 5.0.0 :x: |  :white_check_mark: | 5.0.0 :x: |  :white_check_mark: | net8.0, net9.0 :x: |
| [Cake.Issues.PullRequests.AzureDevOps 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.PullRequests.GitHubActions 5.9.1](https://cakeissues.net/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
| [Cake.Issues.Reporting 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Reporting.Console 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Reporting.Generic 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Reporting.Sarif 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Sarif 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Tap 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Issues.Terraform 6.1.0](https://cakeissues.net/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Json 11.0.0](https://github.com/cake-contrib/Cake.Json/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Liquibase 0.1.18](https://github.com/papauorg/Cake.Liquibase/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.Mage 2.0.0](https://github.com/cake-contrib/Cake.Mage/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.Mastodon 3.0.0](https://github.com/cake-contrib/Cake.Mastodon/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| Cake.Microsoft.Extensions.Configuration 0.1.0-alpha004 | 0.23.0 :x: |  :white_check_mark: |  |  | netstandard1.6 :x: |
| [Cake.MicrosoftTeams 6.0.0](https://github.com/cake-contrib/Cake.MicrosoftTeams/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.MsDeploy 5.0.0](https://github.com/cake-contrib/Cake.MsDeploy/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.Npm 5.1.0](https://github.com/cake-contrib/Cake.Npm/) | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
| [Cake.Npx 1.7.0](https://github.com/michael-wolfenden/Cake.Npx/) | 1.0.0 :x: |  :white_check_mark: |  |  | netstandard2.0 :x: |
| [Cake.NScan 0.600.0](https://grzesiek-galezowski.github.io/nscan/) | 6.2.0 :warning: |  :white_check_mark: |  |  | net10.0 :x: |
...
| Cake.OpenCppCoverage 1.0.0 | 5.0.0 :x: |  :x: |  |  | net8.0 :x: |
...
| Cake.Podman 1.0.0 | 5.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0 :x: |
...
| [Cake.Prompt 6.0.0](https://github.com/cake-contrib/Cake.Prompt/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.ReSharperReports 6.0.0](https://github.com/cake-contrib/Cake.ReSharperReports/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.SendGrid 5.0.0](https://github.com/cake-contrib/Cake.SendGrid/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.SFTP 2.0.0](https://cakebuild.net/extensions/cake-sftp/) | 4.0.0 :x: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| [Cake.SharePoint 2.1.2](https://github.com/cake-contrib/Cake.SharePoint/) | 3.0.0 :x: |  :white_check_mark: |  |  | net6.0 :x: |
| Cake.SimpleGitVer 1.3.0 | 4.0.0 :x: |  :x: | 4.0.0 :x: |  :x: | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Slack 6.0.0](https://github.com/cake-contrib/Cake.Slack/) | 6.0.0 :white_check_mark: |  :white_check_mark: | 6.0.0 :white_check_mark: |  :white_check_mark: | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.Sonar 6.0.1](https://github.com/cake-contrib/Cake.Sonar/) | 6.0.0 :white_check_mark: |  :white_check_mark: | 6.0.0 :white_check_mark: |  :white_check_mark: | net8.0, net9.0, net10.0 :white_check_mark: |
...
| [Cake.StrongNameSigner 3.0.0](https://github.com/cake-contrib/Cake.StrongNameSigner/) | 3.0.0 :x: |  :white_check_mark: |  |  | net6.0, net7.0 :x: |
...
| [Cake.Twitter 6.0.0](https://github.com/cake-contrib/Cake.Twitter/) | 6.0.0 :white_check_mark: |  :white_check_mark: |  |  | net8.0, net9.0, net10.0 :white_check_mark: |
| Cake.Tyrannoport 0.4.1 | 1.3.0 :x: |  :white_check_mark: |  |  | net6.0, net7.0, net8.0, netstandard2.0 :x: |
