...
| [Cake.Dungeon 10.2.4](https://github.com/gitfool/Cake.Dungeon/) | gitfool |  :x: | embedded 'fancy' cake-contrib :heavy_check_mark: |  :x: | MIT :heavy_check_mark: | .git missing :warning: |
...
| [Cake.Issues.Recipe 4.10.1](https://cakeissues.net/) | pascalberger | 4.0.0 :heavy_check_mark: | embedded 'fancy' cake-contrib :heavy_check_mark: |  :heavy_check_mark: | MIT :heavy_check_mark: | true :heavy_check_mark: |
