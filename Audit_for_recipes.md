...
| [Cake.Issues.Recipe 3.1.1](https://cakeissues.net/) | pascalberger | 3.0.0 :heavy_check_mark: | embedded 'fancy' cake-contrib :heavy_check_mark: |  :heavy_check_mark: | MIT :heavy_check_mark: | true :heavy_check_mark: |
...
| [Cake.Tool 3.2.0](https://cakebuild.net/) | cake-build |  :x: | embedded custom :warning: |  :x: | MIT :heavy_check_mark: | .git missing :warning: |
